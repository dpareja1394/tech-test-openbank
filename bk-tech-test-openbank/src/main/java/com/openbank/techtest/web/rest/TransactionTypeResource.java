...
/**
 * REST controller for managing {@link com.openbank.techtest.domain.TransactionType}.
 */
@RestController
@RequestMapping("/api")
public class TransactionTypeResource {
    ...
    private static final String ENTITY_NAME = "bktechtestopenbankTransactionType";
