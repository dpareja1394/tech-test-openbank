...
import com.openbank.techtest.config.audit.AuditEventConverter;
import com.openbank.techtest.domain.PersistentAuditEvent;
...
import static com.openbank.techtest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
