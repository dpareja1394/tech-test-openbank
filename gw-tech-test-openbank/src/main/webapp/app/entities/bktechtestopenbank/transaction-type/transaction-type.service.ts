...
export class TransactionTypeService {
  public resourceUrl = SERVER_API_URL + 'services/bktechtestopenbank/api/transaction-types';
  ...
  findAll(): Observable<EntityArrayResponseType> {
    return this.http.get<ITransactionType[]>(`${this.resourceUrl}/findAll`, { observe: 'response' });
  }
}
