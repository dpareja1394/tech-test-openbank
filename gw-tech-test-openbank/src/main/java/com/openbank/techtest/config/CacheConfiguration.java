...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gwtechtestopenbank");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gwtechtestopenbank");
        ...
        config.getMapConfigs().put("com.openbank.techtest.domain.*", initializeDomainMapConfig(jHipsterProperties));
